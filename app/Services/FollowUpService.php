...
final class FollowUpService {
    ...
    public static function createForSession(int $sessionId): void {
        ...
        DB::insert('customer_timeline', ['customer_id'=>$row['customer_id'], 'type'=>'followup_created', 'title'=>'ایجاد پیگیری خودکار', 'body'=>'تاریخ پیگیری: '.Jalali::toJalali($due), 'created_at'=>date('Y-m-d H:i:s')]);
    }
